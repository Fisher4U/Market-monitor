package com.qinyadan.monitor.config;
...
public class Config {
    ...
    public static class Logging {
        // log文件名
        public static String LOG_FILE_NAME = "monitor.log";
        // log文件路径
        public static String LOG_FILE_PATH = "/tmp/monitor";
        // 最大文件大小
        public static int MAX_LOG_FILE_LENGTH = 3 * 1024 * 1024;
        // skywalking 系统错误文件日志
        public static String SYSTEM_ERROR_LOG_FILE_NAME = "monitor-error.log";
    }
}
