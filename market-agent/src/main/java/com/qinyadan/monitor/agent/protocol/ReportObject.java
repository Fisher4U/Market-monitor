...
public class ReportObject implements Cloneable{
    ...
    @Override
    public ReportObject clone() {
        try {
            return (ReportObject) super.clone();
     ...
     * @return
     */
    public ReportObject appendTags(String newTag){
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReportObject)) return false;
