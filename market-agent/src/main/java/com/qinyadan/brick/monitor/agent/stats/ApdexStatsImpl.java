...
public class ApdexStatsImpl implements ApdexStats {
	...
	public void writeJSONString(Writer writer) throws IOException {
		...
		List<Number> data = Arrays
				.asList(new Number[] { Integer.valueOf(this.satisfying), Integer.valueOf(this.tolerating),
						Integer.valueOf(this.frustrating), Double.valueOf(apdexT), Double.valueOf(apdexT), ZERO });
